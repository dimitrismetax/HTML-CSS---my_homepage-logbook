...
public class CS359DB {
    ...
    private static final String UNAME = "csd3802"; // Share your repo to give you the credentials
    private static final String PASSWD = "z7X%VDGN";  // Share your repo to give you the credentials
